...
const Home = () => {
  const TechWords = ["Full Stack Developer", "Design Learnee", "Tech Enthusiast", "Machine Learning Learnee"];
  const name = [

    {
      text: "Syed",
      className: "text-red-500 dark:text-red-500 md:text-6xl text-2xl lg:text-7xl",
    },
    {
      text: "Arbaaz",
      className: "text-green-500 dark:text-green-500 md:text-6xl text-2xl lg:text-7xl",
    },
    {
      text: "Hussain",
      className: "text-blue-500 dark:text-blue-500 md:text-6xl text-2xl lg:text-7xl",
    },
  ];
  return (
      <LampContainer>
